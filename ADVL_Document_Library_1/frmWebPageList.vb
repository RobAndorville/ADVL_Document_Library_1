...
#Region " Variable Declarations - All the variables used in this form and this application." '=================================================================================================
    ...
    Dim Zip As ADVL_Utilities_Library_1.ZipComp
...
#Region " Form Methods - The main actions performed by this form." '===========================================================================================================================
    ...
    Public Sub UpdateWebPageList()
        ...
        If Main.Project.DataLocn.Type = ADVL_Utilities_Library_1.FileLocation.Types.Directory Then
            ...
            Next
        ElseIf Main.Project.DataLocn.Type = ADVL_Utilities_Library_1.FileLocation.Types.Archive Then
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        'Edit the selected WorkFlow html file.
        ...
        If FileName = "" Then
            Main.Message.AddWarning("No page selected." & vbCrLf)
        Else
            Dim FormNo As Integer = Main.OpenNewWFHtmlDisplayPage()
            Main.WFHtmlDisplayFormList(FormNo).FileName = FileName
            Main.WFHtmlDisplayFormList(FormNo).OpenDocument
        End If
    End Sub
    ...
    Private Sub btnNew_Click(sender As Object, e As EventArgs)
        ...
        Else
            ...
            sw.Write(Main.DefaultWFHtmlString(PageTitle))
            sw.Flush()
