...
#Region " Properties - All the properties used in this form and this application" '============================================================================================================
    ...
    Property ParentWebPageName As String
        Get
            Return _parentWebPageName
        End Get
        Set(value As String)
            _parentWebPageName = value
        End Set
    End Property

    Private _parentWebPageFormNo As Integer = -2 'The form number number of the web page that opened this web page.
...
#Region " Methods Called by JavaScript - A collection of methods that can be called by JavaScript in a web page shown in WebBrowser1" '========================================================
    ...
    Public Sub OpenWebPage(ByVal WebPageFileName As String)
        ...
        Main.WebViewFormList(NewFormNo).ParentWebPageFormNo = FormNo 'Set the Parent Form Number property.
        Main.WebViewFormList(NewFormNo).Description = ""             'The web page description can be blank.
        Main.WebViewFormList(NewFormNo).FileDirectory = ""           'Only Web files in the Project directory can be opened from another Web Page Form.
        Main.WebViewFormList(NewFormNo).FileLocationType = LocationTypes.Project 'Only Web files in the Project directory can be opened from another Web Page Form.
        Main.WebViewFormList(NewFormNo).FileName = WebPageFileName  'Set the web page file name to be opened.
        Main.WebViewFormList(NewFormNo).OpenDocument                'Open the web page file name.
